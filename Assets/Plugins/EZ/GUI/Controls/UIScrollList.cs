...
public class UIScrollList : MonoBehaviour, IUIObject
{
	...
	protected void Awake()
	{
		...
		lowPassFilterFactor = Time.fixedDeltaTime / lowPassKernelWidthInSeconds;
	}
...
*/
	...
	public void RemoveItem(int index, bool destroy)
	{
		...
		if (lastClickedControl != null && (lastClickedControl == items[index] ||
			lastClickedControl.Container.Equals(items[index])))
